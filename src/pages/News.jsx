        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-slate-600">
              Stay updated with the latest announcements, health tips, and
              success stories from Holy Touch Hospital.
            </p>
          </div>
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <button className="flex items-center gap-2 text-slate-900 font-bold text-sm hover:gap-3 transition-all group">
                    ...
                    <ArrowRight
                      size={16}
                      className="text-medical-600 group-hover:text-medical-500"
                    />
                  </button>
                </div>
              </motion.article>
