...
export const hospitalFacilities = [
  {
    ...
    desc: "All types of operations are performed by specialist doctors with full inpatient care.",
    original: "বিশেষজ্ঞ চিকিৎসক দিয়ে রোগী ভর্তি রেখে সব ধরনের অপারেশন করা হয়।",
    icon: Stethoscope,
  },
  {
    id: 2,
    title: "Modern OT Complex",
    desc: "03 (Three) state-of-the-art, air-conditioned Operation Theaters.",
  ...
  },
  {
    ...
    desc: "VIP, Deluxe, AC, and Non-AC cabins equipped with modern amenities.",
    original: "সর্বাধুনিক ব্যবস্থাসহ ভি.আই.পি., ডিলাক্স, এসি ও নন-এসি কেবিন।",
    icon: Bed,
  },
  {
    id: 4,
    title: "Separate Wards",
    desc: "Spacious and separate wards arranged specifically for male and female patients.",
    original: "মহিলা ও পুরুষ রোগীদের জন্য সু-প্রশস্ত আলাদা ওয়ার্ড-এর ব্যবস্থা।",
    icon: Users,
  },
  {
    id: 5,
    title: "Laser Surgery",
    desc: "Various types of advanced surgeries are performed using modern Laser technology.",
    original: "লেজার মেশিনের মাধ্যমে বিভিন্ন ধরনের অপারেশন করা হয়।",
    icon: Zap,
  },
  {
    id: 6,
    title: "Modern Diagnostics",
    desc: "All pre-operative tests are conducted using modern diagnostic machines.",
    original: "অপারেশনের জন্য সকল ধরনের টেস্ট আধুনিক মেশিনে করা হয়।",
    icon: Thermometer,
  },
  {
    id: 7,
    title: "Advanced Laparoscopy",
    desc: "Complex abdominal surgeries performed with minimal incisions using Laparoscopic machines.",
    original: "ল্যাপারোস্কোপিক মেশিনের সাহায্যে কম কাটা দিয়ে জটিল পেট অপারেশন সহ সকল অপারেশন করা হয়।",
    icon: Microscope,
  },
  {
    id: 8,
    title: "Ultrasonography",
    desc: "Advanced Ultrasonogram services available for accurate diagnosis.",
    original: "আল্ট্রাসোনোগ্রাম করা হয়।",
    icon: HeartPulse,
  },
  {
    id: 9,
    title: "Painless Piles Surgery",
    desc: "Piles operations performed efficiently using modern technology.",
    original: "অত্যাধুনিক উপায়ে দক্ষ মেশিনের সাহায্যে পাইলস অপারেশন করা হয়।",
    icon: Activity,
  },
  {
    id: 10,
    title: "24/7 Ambulance",
    desc: "Round-the-clock ambulance service available for patient transport.",
    original: "রোগী আনা-নেয়ার জন্য সার্বক্ষণিক অ্যাম্বুলেন্স সেবা।",
    icon: Ambulance,
  },
  {
    id: 11,
    title: "Utilities & Hygiene",
    desc: "24/7 electricity backup and purified filtered drinking water for all.",
    original: "সার্বক্ষণিক বিদ্যুৎ ও ফিল্টারিং করা বিশুদ্ধ খাবার পানির ব্যবস্থা।",
    icon: Zap,
  },
  {
    id: 12,
    title: "Quality Assurance",
    desc: "We guarantee cleanliness and the highest standard of service at all times.",
    original: "পরিস্কার পরিচ্ছন্নতা ও সার্বক্ষণিক সর্বোচ্চ সার্ভিসের নিশ্চয়তা।",
    icon: Smile,
  },
];
